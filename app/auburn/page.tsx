...
export const metadata: Metadata = {
  title: "Car Locksmith Auburn | 24/7 Emergency Auto Locksmith",
  description: "Professional car locksmith services in Auburn. 24/7 emergency lockout, key replacement, ignition repair. Fast, reliable, licensed. Call now!",
  keywords: "car locksmith auburn, emergency locksmith auburn, car key replacement auburn, ignition repair auburn",
  openGraph: {
    title: "Car Locksmith Auburn | 24/7 Emergency Auto Locksmith",
    description: "Professional car locksmith services in Auburn. 24/7 emergency lockout, key replacement, ignition repair.",
    url: "https://carlocksmithsydney.com.au/auburn",
...
const localBusinessSchema = {
  ...
  description: "Professional 24/7 car locksmith services in Auburn. Emergency lockout, key replacement, ignition repair.",
  url: "https://carlocksmithsydney.com.au/auburn",
    ...
    <>
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Car Locksmith in <span className="text-yellow-400">Auburn</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Fast, reliable, and professional car locksmith services in Auburn. 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Professional Car Locksmith Services in Auburn
            </h2>
            <p className="text-lg text-gray-600 mb-12 leading-relaxed">
              Serving the vibrant community of Auburn, we provide comprehensive automotive locksmith services 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              Why Choose Our Auburn Car Locksmith Service?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Quick arrival times throughout Auburn and surrounding areas</p>
              </div>
              <div className="text-center">
                <div className="bg-yellow-400 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              Our Car Locksmith Services in Auburn
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  "Amazing service! Got locked out in Auburn and they were here in 15 minutes. 
                  Professional and affordable - highly recommend!"
                </p>
                <p className="font-semibold text-slate-900">- Sarah M., Auburn</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <div className="flex items-center mb-4">
                  <div className="flex text-yellow-400">
                ...
                <p className="text-gray-600 mb-4">
                  "Needed a new car key in Auburn. Fast service, great price, and the key works perfectly. 
                  Will definitely use again!"
                </p>
                <p className="font-semibold text-slate-900">- Michael T., Auburn</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  How quickly can you reach me in Auburn?
                </h3>
                <p className="text-gray-600">
                  We typically arrive within 15-20 minutes throughout Auburn and surrounding areas.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  Do you service all areas of Auburn?
                </h3>
                <p className="text-gray-600">
                  Yes, we cover all of Auburn and nearby suburbs to ensure comprehensive coverage.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  What types of vehicles do you work with in Auburn?
                </h3>
                <p className="text-gray-600">
                  We service all vehicle makes and models, from compact cars to luxury vehicles, 
                  including European and Asian imports commonly found in Auburn.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  Are your services available 24/7 in Auburn?
                </h3>
                <p className="text-gray-600">
                  Absolutely! We provide 24/7 emergency locksmith services throughout Auburn, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our car locksmith services extend beyond Auburn to surrounding areas
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Need a Car Locksmith in Auburn?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Don't wait - call us now for fast, reliable service throughout Auburn
            </p>
