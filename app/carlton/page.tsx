...
export const metadata: Metadata = {
  title: "Car Locksmith Carlton | 24/7 Emergency Auto Locksmith",
  description: "Professional car locksmith services in Carlton. 24/7 emergency lockout, key replacement, ignition repair. Fast, reliable, licensed. Call now!",
  keywords: "car locksmith carlton, emergency locksmith carlton, car key replacement carlton, ignition repair carlton",
  openGraph: {
    title: "Car Locksmith Carlton | 24/7 Emergency Auto Locksmith",
    description: "Professional car locksmith services in Carlton. 24/7 emergency lockout, key replacement, ignition repair.",
    url: "https://carlocksmithsydney.com.au/carlton",
...
const localBusinessSchema = {
  ...
  description: "Professional 24/7 car locksmith services in Carlton. Emergency lockout, key replacement, ignition repair.",
  url: "https://carlocksmithsydney.com.au/carlton",
    ...
    <>
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Car Locksmith in <span className="text-yellow-400">Carlton</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Fast, reliable, and professional car locksmith services in Carlton. 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Professional Car Locksmith Services in Carlton
            </h2>
            <p className="text-lg text-gray-600 mb-12 leading-relaxed">
              Serving the vibrant community of Carlton, we provide comprehensive automotive locksmith services 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              Why Choose Our Carlton Car Locksmith Service?
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Quick arrival times throughout Carlton and surrounding areas</p>
              </div>
              <div className="text-center">
                <div className="bg-yellow-400 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              Our Car Locksmith Services in Carlton
            </h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              What Our Carlton Customers Say
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  "Amazing service! Got locked out in Carlton and they were here in 15 minutes. 
                  Professional and affordable - highly recommend!"
                </p>
                <p className="font-semibold text-slate-900">- Sarah M., Carlton</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <div className="flex items-center mb-4">
                  <div className="flex text-yellow-400">
                ...
                <p className="text-gray-600 mb-4">
                  "Needed a new car key in Carlton. Fast service, great price, and the key works perfectly. 
                  Will definitely use again!"
                </p>
                <p className="font-semibold text-slate-900">- Michael T., Carlton</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 text-center mb-12">
              Frequently Asked Questions - Carlton
            </h2>
            <div className="space-y-6">
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  How quickly can you reach me in Carlton?
                </h3>
                <p className="text-gray-600">
                  We typically arrive within 15-20 minutes throughout Carlton and surrounding areas.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  Do you service all areas of Carlton?
                </h3>
                <p className="text-gray-600">
                  Yes, we cover all of Carlton and nearby suburbs to ensure comprehensive coverage.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  What types of vehicles do you work with in Carlton?
                </h3>
                <p className="text-gray-600">
                  We service all vehicle makes and models, from compact cars to luxury vehicles, 
                  including European and Asian imports commonly found in Carlton.
                </p>
              </div>
              <div className="bg-slate-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-slate-900 mb-2">
                  Are your services available 24/7 in Carlton?
                </h3>
                <p className="text-gray-600">
                  Absolutely! We provide 24/7 emergency locksmith services throughout Carlton, 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our car locksmith services extend beyond Carlton to surrounding areas
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Need a Car Locksmith in Carlton?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Don't wait - call us now for fast, reliable service throughout Carlton
            </p>
